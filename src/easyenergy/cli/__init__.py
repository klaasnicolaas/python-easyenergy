...
@cli.command("energy")
async def command_energy(  # noqa: PLR0913, PLR0917  # pylint: disable=too-many-arguments,too-many-positional-arguments
...
async def command_prices_list(  # noqa: PLR0913, PLR0917  # pylint: disable=too-many-arguments,too-many-positional-arguments
    date_value: DateOption = None,
    start_date: StartDateOption = None,
    end_date: EndDateOption = None,
    vat: VatOptionArg = VatOption.INCLUDE,
